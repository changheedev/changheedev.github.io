...
-   Mac su 명령 사용시 su:sorry 문제 해결 방법 - https://pragp.tistory.com/entry/Mac-OS-X에서-루트-사용자su-활성화-및-사용

-   Error: Permission denied @ dir_s_mkdir 해결 방법 - https://worthpreading.tistory.com/89
...
It will automatically generates the _Latest Modified Date_ and _Categories / Tags_ page for the posts and submit a commit, then push to `origin/master`. Its output is similar to the following log:
